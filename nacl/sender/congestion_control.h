...
#ifndef SENDER_CONGESTION_CONTROL_H_
#define SENDER_CONGESTION_CONTROL_H_
...
class CongestionControl {
 public:
  ...
  virtual void SendFrameToTransport(uint32_t frame_id, size_t frame_size,
  ...
  virtual uint32_t GetBitrate(base::TimeTicks playout_time,
...
#endif  // SENDER_CONGESTION_CONTROL_H_
